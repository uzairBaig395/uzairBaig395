...
<tr>
<td align="center" style="background: linear-gradient(135deg, #0d1117 0%, #161b22 100%); padding: 40px 20px; border: none; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.3);">
...
<svg width="100%" height="180" viewBox="0 0 640 380" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(320,160)">
    ...
    <g>
      ...
      <circle r="58" fill="none" stroke="#0369a1" stroke-width="3.2" stroke-linecap="round" stroke-dasharray="300 364" transform="rotate(-90)"/>
    </g>
    <g>
      <animateTransform attributeName="transform" type="rotate" from="0" to="360" dur="2.4s" repeatCount="indefinite"/>
      <circle cx="58" cy="0" r="4" fill="#7c3aed">
        <animate attributeName="opacity" values="0;1;1;0" keyTimes="0;0.08;0.9;1" dur="2.4s" repeatCount="indefinite"/>
      </circle>
    </g>
    <text x="0" y="20" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-weight="800" font-size="56" fill="#0369a1">
      U
...
<table width="100%">
<tr bgcolor="#161b22">
<td style="padding: 24px; border: none;" align="center">
...
[![Instagram](https://img.shields.io/badge/Instagram-%23E4405F?style=for-the-badge&logo=instagram&logoColor=white)](https://instagram.com/YOUR_INSTAGRAM_USERNAME)
[![Facebook](https://img.shields.io/badge/Facebook-%231877F2?style=for-the-badge&logo=facebook&logoColor=white)](https://facebook.com/YOUR_FACEBOOK_USERNAME)
